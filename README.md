...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/sanny-kumar-sharma-2a8b7540a?utm_source=share_via&utm_content=profile&utm_medium=member_android)
...
🚀 Featured Projects
🛒 Amazon Clone
Responsive Amazon homepage clone built with HTML and CSS. Demonstrates responsive design principles and modern web layout techniques.

Tech: HTML5, CSS3

🤖 CodeMentor AI
An intelligent coding assistant powered by Google Gemini API to help students with coding problems. Features a clean UI and real-time AI responses.

Tech: HTML, CSS, JavaScript, Gemini API

⏰ Digital Clock
A real-time digital clock displaying current date and time with an elegant UI.

Tech: HTML5, CSS3, JavaScript

🌐 Fetch API Project
JavaScript project demonstrating API fetching techniques with dynamic rendering of random user data.

Tech: JavaScript, REST API

🔐 Login Form
A modern, responsive login form with validation and user-friendly interface.

Tech: HTML5, CSS3, JavaScript

💼 Personal Portfolio
A modern and responsive portfolio website showcasing projects, skills, and my web development journey.
...
🧠 Problem-solving through coding is my passion
📱 Always exploring new web technologies
🤝 Open to collaboration and learning from the community
📞 Let's Connect!
I'm always excited to discuss web development, collaborate on projects, or just chat about tech!

💼 LinkedIn: Sanny Kumar Sharma
🌐 Portfolio: Check out my personal portfolio
📧 GitHub: Sannny007
